...
// --- MOCK DATA ---
// const CURRENT_USER_ID = "user-123"; // Simulate logged-in user
...
const mockPosts = [
  {
    ...
    timestamp: "2h ago",
    content:
      "Just posted a major update to our 'Sustainable Water' project! We've successfully secured the initial materials and are starting construction next week. Huge thanks to everyone who has backed us so far! 💙",
  ...
  },
  {
    ...
    timestamp: "5h ago",
    content:
      "I've been browsing the 'Tech Innovation' category today. So many incredible ideas. Just put some funds towards the new AI educational tool. Really hoping it hits its goal!",
  ...
  },
  {
    ...
    timestamp: "1d ago",
    content:
      "We are 80% funded! Only 3 days left to reach our goal to buy the new greenhouse equipment. Please share if you can!",
    linkedCampaign: {
      id: "c2",
    ...
    <article className="bg-white border-b border-gray-200 p-4 hover:bg-gray-50 transition-colors duration-150">
      <div className="flex space-x-3">
        ...
        <div className="shrink-0">
          <div
            className={`h-10 w-10 rounded-full flex items-center justify-center text-white font-bold ${post.user.avatarBg}`}
          >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center flex-wrap truncate">
              <span className="text-sm font-bold text-gray-900 mr-1 truncate">
                {post.user.name}
              </span>
              {post.user.role !== "user" && (
                <span
                  className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium mr-2 capitalize ${roleBadgeColor}`}
                >
                  {post.user.role === "creator" && (
            ...
            <div className="mt-3 border border-gray-200 rounded-xl overflow-hidden bg-gray-50 hover:border-indigo-300 transition-colors cursor-pointer">
              {post.linkedCampaign.imageUrl && (
                <div className="h-32 w-full overflow-hidden relative">
                  <img
                    src={post.linkedCampaign.imageUrl}
                    alt={post.linkedCampaign.title}
              ...
              <div className="p-3">
                ...
                <h4 className="font-bold text-gray-900">
                  {post.linkedCampaign.title}
                </h4>
                <ProgressBar
                  raised={post.linkedCampaign.raised}
                  goal={post.linkedCampaign.goal}
                />
...
const SocialFeed = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen font-sans">
      ...
      <main className="max-w-3xl mx-auto sm:pt-4 pb-20">
        <div className="text-center flex flex-row items-center justify-between p-4">
