...
const CreatorStatCard: React.FC<CreatorStatCardProps> = ({
  title,
  value,
  subtitle,
  icon: Icon,
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-1.5 flex-1 pr-2">
            ...
            <div className="flex items-baseline gap-2 flex-wrap">
              ...
              {badgeText && (
                <Badge variant={badgeVariant} className="text-[10px] font-semibold py-0.5 px-2 rounded-full">
                  {badgeText}
                </Badge>
              )}
            </div>
          ...
          <div className={`p-3 rounded-2xl shrink-0 flex items-center justify-center shadow-xs ${iconBgClass}`}>
