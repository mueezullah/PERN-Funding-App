...
export function FeedCard({ id, type = 'campaign', user, content, stats }: FeedCardProps) {
  ...
  return (
    <article className="bg-white rounded-3xl shadow-sm border mb-8 border-slate-200/60 p-5 sm:p-6 transition-all hover:shadow-md">
      ...
      <div className="mb-4">
        ...
        <p className="text-slate-600 leading-relaxed text-[15px] sm:text-[16px] whitespace-pre-wrap">{content.description}</p>
      </div>
