...
const DonationModal = ({ isOpen, onClose, campaignId }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[95vh] overflow-y-auto flex flex-col relative relative">
                    ...
                    {stage === 1 && (
                        <div className="flex flex-col gap-4">
                            <p className="text-gray-600 text-sm">
                                Enter the amount you would like to contribute. Your support makes a difference!
                            </p>
